...
it('does not create import tables in F04', function (): void {
    // import_files/import_rows/import_batches are added by the Imports module (post-F04) — guard updated.
...
it('does not create student tables in F04', function (): void {
    ...
    // student_profiles is now legitimately created by the Students module (post-F04) — guard updated.
