...
<div class="report-centre-page">
            ...
            @forelse($this->definitions as $family => $defs)
                ...
                <div class="report-family-section">
                    ...
                    <div class="report-cards-grid">
                        ...
                        @foreach ($defs as $def)
                            <button type="button" wire:click="selectDefinition('{{ $def->code }}')"
    ...
    ========================================================== --}}
        @if ($this->selectedDefinition)
            ...
            <div id="selected-report" class="selected-report-wrapper">
                ...
                <div class="selected-report-card mb-4">
                    ...
                    <div class="report-filters">
                            ...
                            @if (in_array('institution_semester_id', $this->filterSchema, true))
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" style="margin:0">
                                        ...
                                        <select class="form-control" wire:model.live="semesterId">
                            ...
                            @if (in_array('class_group_id', $this->filterSchema, true))
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" style="margin:0">
                                        ...
                                        <label class="form-label" for="classGroupId">
                                            {{ __('reports.class_group') }}
                                        </label>

                                        <select id="classGroupId" wire:model.live="classGroupId" class="form-control">
                            ...
                            @if (in_array('operational_period_id', $this->filterSchema, true))
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" style="margin:0">
                                        ...
                                        <select class="form-control" wire:model.live="periodId">
                        ...
                        <div class="report-actions mt-4">
                            ...
                            <button type="button" wire:click="runReport" wire:loading.attr="disabled"
                                class="action-button action-primary">

                                <span wire:loading wire:target="runReport"
                                    class="spinner-border spinner-border-sm"></span>

                                <i wire:loading.remove wire:target="runReport" class="bi bi-play-circle"></i>
                            ...
                            @if ($canExport)
                                <button type="button" wire:click="exportReport" wire:loading.attr="disabled"
                                    ...
                                    <i wire:loading.remove wire:target="exportReport"
                ...
                @if ($this->pendingOperation)
                    ...
                    <div wire:poll.3s
                        class="export-status-card {{ match ($this->pendingOperation->status) {
                            'completed' => 'completed',
                            'failed' => 'failed',
                            default => 'processing',
                        } }}">
                        ...
                        <div class="export-status-info">
                            ...
                            <div>
                                ...
                                @if ($this->pendingOperation->status === 'failed')
                                    <small>
                                        {{ $this->pendingOperation->failure_summary ?? __('reports.unknown_error') }}
                                    </small>
                                @elseif($this->pendingOperation->status !== 'completed')
                                    <small>

                                        {{ $this->pendingOperation->status === 'queued' ? __('reports.queued') : __('reports.processing') }}
                        ...
                        @if ($this->pendingOperation->status === 'completed')
                            <button type="button" wire:click="downloadCompletedExport" class="download-button">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="{{ max(count($this->headings), 1) }}" class="empty-table-cell">
    ...
    ========================================================== --}}
        <style>
            ...
            .report-header-icon {
                ...
                border-radius: 14px;
                background: linear-gradient(135deg, #78aeda, #4f91c5);
                color: #fff;
                font-size: 21px;
                box-shadow: 0 8px 20px rgba(65, 125, 170, .18);
            }
            ...
            .reports-browser-card {
                ...
                border-radius: 16px;
                box-shadow: 0 6px 25px rgba(30, 70, 100, .05);
            }
            ...
            .family-title-icon {
                ...
                justify-content: center;
                border-radius: 9px;
                background: linear-gradient(135deg, #e4f0fa, #d5e8f6);
                color: #397cae;
                font-size: 13px;
            }
            ...
            .report-card {
                ...
                border-radius: 15px;
                background: linear-gradient(135deg, #dcecf9 0%, #c9e1f4 50%, #b8d6ef 100%);
                color: #244b68;
                text-align: start;
                cursor: pointer;
                overflow: hidden;
                box-shadow: 0 6px 18px rgba(45, 95, 130, .10);
            ...
            .report-card.selected {
                ...
                background: linear-gradient(135deg, #dcecf9 0%, #c9e1f4 50%, #b8d6ef 100%);
                box-shadow: 0 8px 22px rgba(45, 95, 130, .14);
            }
            ...
            .report-card:hover {
                ...
                border-color: #8fb9da;
                background: linear-gradient(135deg, #e5f2fc 0%, #d2e7f7 50%, #c0dcf0 100%);
                box-shadow: 0 12px 28px rgba(45, 95, 130, .17);
            }
            ...
            .report-card-icon {
                ...
                color: #285e86;
                font-size: 18px;
                box-shadow: 0 4px 10px rgba(40, 90, 125, .08);
            }
            ...
            .report-card-footer {
                ...
                justify-content: space-between;
                padding-top: 12px;
                border-top: 1px solid rgba(40, 90, 125, .13);
                color: #376b8d;
                font-size: 10px;
                font-weight: 600;
            }
            ...
            .selected-report-wrapper {
                ...
                animation: reportAppear .35s ease;
            }
            ...
            .selected-report-card {
                ...
                border: 1px solid #dfe8f0;
                border-radius: 15px;
                box-shadow: 0 7px 25px rgba(30, 70, 100, .06);
            }
            ...
            .selected-report-icon {
                ...
                color: #fff;
                font-size: 20px;
                box-shadow: 0 7px 18px rgba(65, 125, 170, .18);
            }
            ...
            .report-filters .form-control:focus {
                border-color: #75a9ce;
                outline: none !important;
                box-shadow: 0 0 0 3px rgba(75, 145, 195, .10);
            }
            ...
            .action-primary {
                border: 1px solid #5594bd;
                background: linear-gradient(135deg, #69a6cf, #4387b8);
                color: #fff;
                box-shadow: 0 6px 15px rgba(65, 125, 170, .16);
            }
            ...
            .action-success:hover {
                ...
                color: #285f83;
                transform: translateY(-2px);
                box-shadow: 0 8px 17px rgba(65, 125, 170, .12);
            }
            ...
            .results-card {
                ...
                border: 1px solid #dfe8f0;
                border-radius: 15px;
                box-shadow: 0 7px 25px rgba(30, 70, 100, .05);
            }
            ...
            .no-report-icon {
                ...
                margin-bottom: 15px;
                border-radius: 17px;
                background: linear-gradient(135deg, #e7f3fa, #d7eaf5);
                color: #4b86ae;
                font-size: 27px;
            }
