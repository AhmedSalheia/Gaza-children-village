...
namespace Database\Factories\Modules\Accounts;
...
/**
 * @extends Factory<AdministrativeAccount>
 */
final class AdministrativeAccountFactory extends Factory
{
    protected $model = AdministrativeAccount::class;
