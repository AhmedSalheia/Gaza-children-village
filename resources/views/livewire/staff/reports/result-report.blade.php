            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0 align-middle">
                    <thead class="table-light">
                        <tr><th>المجموعة</th><th>المادة</th><th>المعلم</th><th>الحالة</th><th>الإصدار</th><th>التقديم</th><th>الاعتماد</th></tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="7" class="text-center text-muted py-4">لا توجد جداول.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    @else
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0 align-middle">
                    <thead class="table-light">
                        <tr><th>المجموعة</th><th>الطالب</th><th>المادة</th><th>الدرجة</th><th>التقدير</th><th>الحالة</th></tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="6" class="text-center text-muted py-4">لا توجد نتائج منشورة.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
