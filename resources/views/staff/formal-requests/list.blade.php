                        ...
                        <tr>
                            ...
                            <td>
                                <span class="formal-type">
                                    ...
                                    {{ __('requests.types.' . $req->request_type) }}
                                </span>
                            </td>
                            ...
                            <td>
                                ...
                                @if(in_array($req->current_status, ['closed', 'cancelled', 'superseded']))

                                    <span class="formal-status formal-status-gray">
                                        <span></span>
                                        {{ __('requests.statuses.' . $req->current_status) }}
                                    </span>
                            ...
                            <td>
                                ...
                                @php
                                    $priorityLabels = [
                                        1 => __('requests.priority_low'),
                                        2 => __('requests.priority_medium'),
                                        3 => __('requests.priority_high'),
                                        4 => __('requests.priority_urgent'),
                                    ];
                                @endphp

                                <span
                                    class="formal-priority
                                        @if($req->priority == 4) priority-urgent
                                        @elseif($req->priority == 3) priority-high
                                        @elseif($req->priority == 2) priority-medium
                                        @else priority-low
                                        @endif
                                    "
                                >
                            ...
                            <td>
                                ...
                                <div class="formal-actions">
                                    ...
                                    <a
                                        href="{{ route('staff.formal-requests.detail', $req->id) }}"
